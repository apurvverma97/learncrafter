...
class ValidationService:
    ...
    def validate_content(self, content: str) -> ValidationResult:
        ...
        try:
            ...
            if len(content) > settings.max_content_length:
                errors.append(f"Content exceeds maximum length of {settings.max_content_length} characters")
    ...
    def _validate_security(self, soup: BeautifulSoup) -> Tuple[List[str], List[str]]:
        ...
        if dangerous_tags:
            errors.append(f"Dangerous tags found: {[tag.name for tag in dangerous_tags]}")
